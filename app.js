...
function getVehicleType(fleetNumber) {
	...
	if (num >= 2301 && num <= 2399) return "StreetDeck EV";
	...
	if (num >= 3401 && num <= 3560) return "Streetdeck";
	...
	if (num >= 9005 && num <= 9013) return "Volvo B7RLE Eclipse";
	if (num >= 9101 && num <= 9109) return "Mercedes Citaro";
	...
	if (num >= 15190 && num <= 15853) return "Scania E400";
	if (num >= 16957 && num <= 16958) return "B9TL Gemini OT";
	if (num >= 17502 && num <= 18539) return "ALX 400 Trident";
	if (num >= 18901 && num <= 18938) return "StreetDeck HEV";
	if (num >= 19001 && num <= 19916) return "ADL E400";
	if (num >= 21351 && num <= 21440) return "B8RLE Evora";
	if (num >= 22087 && num <= 22401) return "MAN ALX300";
	if (num >= 22521 && num <= 24152) return "MAN E300";
	if (num >= 26001 && num <= 26359) return "ADL E200MMC";
	if (num >= 27101 && num <= 27959) return "ADL E300";
	if (num >= 34473 && num <= 34810) return "Dennis Dart";
	if (num >= 36011 && num <= 37327) return "ADL E200";
	if (num >= 37328 && num <= 37667) return "ADL E200MMC";
	if (num >= 39101 && num <= 39118) return "Wright Streetlite DF";
	if (num >= 44003 && num <= 44026) return "Mercedes Sprinter";
	if (num >= 44901 && num <= 44904) return "Mellor Strata";
	if (num >= 46021 && num <= 46024) return "ADL E100EV";
	if (num >= 47301 && num <= 47599) return "Optare Solo";
	if (num >= 47701 && num <= 48194) return "Optare Solo SR";
	if (num >= 54305 && num <= 54308) return "Volvo B11R Elite";
	if (num >= 54401 && num <= 54412) return "Volvo B11R Levante";
	if (num >= 66071 && num <= 66082) return "BZL Midi";
	if (num >= 63101 && num <= 63133) return "Yutong E10";
	if (num >= 73001 && num <= 73299) return "Yutong E12";
	...
	if (num >= 89001 && num <= 89010) return "ADL E400FCEV";
	return "Unknown";
}
